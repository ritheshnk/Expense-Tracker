        ...
        <>
            <nav className="mx-auto flex flex-wrap w-full max-w-4xl  justify-center items-center gap-6 p-4">
                ...
                <ul className="ml-auto flex gap-4 items-center ">
                    <li><button className="hover:text-yellow-500 focus:outline-none">Expenses</button></li>
                    <li><button className="hover:text-yellow-500 focus:outline-none">About</button></li>
                    <li><button onClick={handleRefresh} className="hover:text-yellow-500 focus:outline-none">Refresh</button></li>
                </ul>
            </nav>
        </>
    )
